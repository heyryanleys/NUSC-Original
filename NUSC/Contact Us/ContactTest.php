...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/Contact Us.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
p.darkblue{
	...
	<link href="contactform_test.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
...
.ECC {
 ...
 <style type="text/css">
       a:link {color: #1046B2;}      /* unvisited link */
       a:visited {color: #1046B2;}   /* visited link */
       a:hover {color: #1046B2;}     /* mouse over link */
       a:active {color: #1046B2;}    /* selected link */
    </style>
</style>
...
<map name="Map" id="Map">
  <area shape="rect" coords="30,6,185,168" href="../../NUSC/" alt="Home" />
</map>
...
<div align="center">
 ...
 <ul>
  ...
  <ul>
    ...
    <li><a href="../results.html">Past Seasons</a></li>
    </ul>
    </li>
  </ul>
...
// Set email variables
$email_to = 'kevin.gell.93@gmail.com';
...
?>
         ...
         <form action="contact.php" method="post" id="comments_form">
			...
			<?php else: ?>
<p style="font-size:35px; font-family:arial Arial, Helvetica, sans-serif; color:#255E67; margin-left:25px;">Thank you for your Message!</p>
